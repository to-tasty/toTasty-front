...
export default function NewMeetingCardArea() {
  return (
    <Carousel
      className="relative w-[1142px] overflow-visible" // overflow-visible로 다음/이전 버튼이 잘 보이도록
      opts={{ loop: false, align: 'start', containScroll: 'trimSnaps' }} // align:"start"로 첫 카드가 왼쪽에 붙음
