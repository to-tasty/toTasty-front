...
function CarouselContent({ className, ...props }: React.ComponentProps<'div'>) {
  ...
  return (
    <div ref={carouselRef} className="overflow-hidden" data-slot="carousel-content">
      <div
        className={cn('flex', orientation === 'horizontal' ? 'gap-4' : 'flex-col gap-4', className)}
        {...props}
      />
    </div>
  );
...
function CarouselPrevious({
  ...
  return (
    <Button
      ...
      {...props}
    >
      <ChevronLeft className="w-5 h-5 scale-[1.4]" strokeWidth={3} />
...
function CarouselNext({
  ...
  return (
    <Button
      ...
      {...props}
    >
      <ChevronRight className="w-5 h-5 scale-[1.4]" strokeWidth={3} />
