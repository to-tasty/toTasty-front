  ...
  return (
    ...
    >
      ...
      <div className="flex ml-3 mt-3 items-center justify-between">
        ...
        <div className="flex items-center">
          <div className="flex w-[60px] h-[20px] border rounded-xs mr-1 justify-center items-center">
            <span className="text-xs font-medium">시음리스트</span>
          </div>
      ...
      <div className="flex justify-end mt-0.5 px-2">
        <span className="text-xs text-purple-500">{meetingInfo.currentParticipants}</span>
        <span className="text-xs text-gray-500">/ {meetingInfo.maxParticipants}명</span>
      </div>
      ...
      <span className="ml-3 mt-1 text-xs font-normal">{meetingStartDate} 출발</span>
    </div>
  );
}
